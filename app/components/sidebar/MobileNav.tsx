...
const MobileNav: FC<MobileTypes> = ({navMobile, setNavMobile, currentUser}) => {
   ...
   return (
      <div
         className={
            navMobile
               ? 'lg:hidden fixed left-0 top-0 w-full h-screen bg-primary/80 z-80 ease-in-out duration-700'
            ...
            {currentUser && (
               <div className='pb-3 space-y-2 border-b border-white trans'>
                  <div className='flex items-center space-x-3'>
                     ...
                     />
                     <p className='text-white trans font-[500]'>
                        {currentUser?.name}
                     </p>
                  </div>
